...
def show_label():
    ...
    #if labels[i]!='not_assigned':
        #label_info = Label(text=labels[i]+'                    ', fg = 'red', bg = 'SystemButtonFace', font = 'Aria -13 bold').place(x = 450, y = 40)
    #else:
        #label_info = Label(text='                                        ', fg = 'red', bg = 'SystemButtonFace', font = 'Aria -13 bold').place(x = 450, y = 40)
...
diffuse_button = Button(text="diffuse", relief= RAISED, width=15, height= 5,
                        bg='green', fg='black', bd=7, activebackground='green', 
                        activeforeground='white', command=add_diffuse).place(x =1000 , y =180)
other_Aurora_button = Button(text="other Aurora", relief= RAISED, width=15, height= 5,
                        bg='#ADD8E6', fg='black', bd=7, activebackground='green', 
                        activeforeground='white',command=add_other_Aurora).place(x =1000 , y =300)
cloudy_button = Button(text="cloudy", relief= RAISED, width=15, height= 5,
                        bg='#FFFDD0', fg='black', bd=7, activebackground='green', 
                        activeforeground='white',command=add_cloudy).place(x =1000 , y =420)
...
Erase_button = Button(text="Erase", relief= RAISED, width=15, height= 2,
                        bg='gray', fg='black', bd=7, activebackground='green', 
                        activeforeground='white',command=Erase_label).place(x =1000 , y =580)
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
